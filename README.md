# Module: CDCalendar
The `CDCalendar` module is revised from the default calendar module of the
MagicMirror. This module displays events from a public .ical calendar. It can
combine multiple calendars. Note that calendars may not contain any entry before
1st January 1970, otherwise the calendar won't be displayed and the module will
crash.
